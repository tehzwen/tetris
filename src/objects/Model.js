class Model {
    ...
    updateBoundingBox() {
        if (!this.boundingBox || !this.model.modelMatrix) {
            return;
        }
    ...
    async setup() {
        // this.originalBoundingBox = await syncGetBoundingBox(this.model.vertices);
        ...
        this.originalBoundingBox = await syncGetBoundingBox(this.model.vertices, modelMatrix);
        this.boundingBox = { ...this.originalBoundingBox };
        this.initBuffers();
    }
